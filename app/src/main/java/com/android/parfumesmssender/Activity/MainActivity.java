...
import com.android.parfumesmssender.Adapter.SmsAdapter;
import com.android.parfumesmssender.Common.AppFont;
import com.android.parfumesmssender.Common.CONSTANT;
import com.android.parfumesmssender.Common.Utils;
import com.android.parfumesmssender.DataBase.SMS;
import com.android.parfumesmssender.DataBase.SmSDB;
import com.android.parfumesmssender.R;
import com.android.parfumesmssender.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String defaultHost = "http://95.85.119.162:5002";
    private String eventName="verification-phone";
...
//                String[] s=res.split(",");
    ...
    public void sendSms(String phone, String code) {
        ...
        SMS sms = new SMS(1, phone, code, CONSTANT.PENDING, sms_id + "",date);
        int flag = 0;
        ...
        smsMgrVar.sendTextMessage(phone, null, code, piSent, piDelivered);
